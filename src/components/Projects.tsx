    ...
    <section id="projects" className="section-padding bg-secondary/10 relative">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group relative flex flex-col h-full rounded-[3.5rem] border border-border bg-background overflow-hidden cursor-pointer hover:border-primary/30 transition-all duration-500 shadow-sm hover:shadow-2xl"
            >
              ...
              <div className="relative p-10 md:p-14 flex flex-col h-full">
                <div className="flex items-center justify-between mb-12">
                  <div className={`p-5 rounded-2xl ${project.color} text-white shadow-xl shadow-inherit/20 group-hover:scale-110 transition-transform duration-500`}>
                    {project.icon}
                  </div>
                ...
                <div className="flex-grow">
                  ...
                  <h3 className="text-3xl md:text-5xl font-black mb-6 tracking-tight group-hover:text-primary transition-colors">{project.title}</h3>
                ...
                <div className="mt-auto pt-10 border-t border-border/50 flex items-center justify-between">
                  <div className="flex items-center gap-3 text-sm font-black text-foreground uppercase tracking-widest">
                    <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary">
                       <Code2 size={16} />
                    </div>
                    Full Case Study
                  </div>
                  <div className="w-16 h-16 rounded-full bg-foreground text-background flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all duration-500 -rotate-45 group-hover:rotate-0 shadow-lg">
        ...
        <div className="mt-32 text-center">
          <button className="px-12 py-6 bg-foreground text-background rounded-3xl font-black text-xl hover:bg-primary hover:text-white transition-all shadow-2xl hover:translate-y-[-4px]">
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 md:p-12">
            ...
            <motion.div
              ...
              className="relative w-full max-w-6xl max-h-[90vh] bg-background border border-border rounded-[3rem] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] overflow-hidden flex flex-col md:flex-row"
            >
              {/* Close Button */}
              <button 
                onClick={() => setSelectedProject(null)}
                className="absolute top-8 right-8 z-50 w-12 h-12 rounded-full bg-secondary hover:bg-primary hover:text-white transition-all flex items-center justify-center"
              >
                <X size={24} />
              </button>

              {/* Sidebar Info */}
              <div className={`w-full md:w-1/3 p-10 md:p-16 bg-gradient-to-br ${selectedProject.gradient} flex flex-col`}>
                <div className={`w-20 h-20 rounded-3xl ${selectedProject.color} text-white flex items-center justify-center mb-10 shadow-2xl shadow-inherit/40`}>
                  {selectedProject.icon}
                </div>
                <h4 className="text-xs font-black text-primary uppercase tracking-[0.3em] mb-4">{selectedProject.subtitle}</h4>
                <h2 className="text-4xl md:text-5xl font-black mb-10 tracking-tight leading-tight">{selectedProject.title}</h2>
              ...
              <div className="flex-1 p-10 md:p-20 overflow-y-auto custom-scrollbar">
                <div className="max-w-3xl">
                  <section className="mb-16">
                    <h5 className="text-primary font-black uppercase tracking-[0.2em] text-xs mb-6 flex items-center gap-2">
                      <Globe size={14} /> Project Overview
                    </h5>
                    <p className="text-2xl font-medium leading-relaxed text-foreground/90 italic">
                  ...
                  <div className="grid grid-cols-1 gap-12">
                    <div className="space-y-6">
                      <h5 className="text-primary font-black uppercase tracking-[0.2em] text-xs flex items-center gap-2">
                    ...
                    <div className="p-10 rounded-3xl bg-primary/5 border border-primary/10 space-y-6">
                      <h5 className="text-primary font-black uppercase tracking-[0.2em] text-xs flex items-center gap-2">
                  ...
                  <div className="mt-16 pt-10 border-t border-border flex items-center justify-between">
                    ...
                    <button className="text-xs font-black uppercase tracking-[0.2em] text-primary hover:underline">
